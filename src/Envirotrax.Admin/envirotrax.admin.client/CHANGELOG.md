...
- Create Angular project with ng: `ng new envirotrax.admin.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`envirotrax.admin.client.esproj`).
