...
public abstract class ProfessionalCrudController<TDto> : ProfessionalCrudController<TDto, int>
        where TDto : class
{
    protected ProfessionalCrudController(IServiceBase<TDto, int> service)
        : base(service)
    {
    }
}

public abstract class ProfessionalCrudController<TDto, TKey> : ProfessionalProtectedController
    where TDto : class
{
    private readonly IServiceBase<TDto, TKey> _service;

    public ProfessionalCrudController(IServiceBase<TDto, TKey> service)
    {
        _service = service;
    }
