        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentWaterSupplierId = table.Column<int>(type: "int", nullable: true),
                    ...
                    PropertyDescription = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    RecordDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notifications", x => new { x.WaterSupplierId, x.Id });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_WaterSupplierUsers_WaterSupplierId_UserId",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ParentWaterSupplierId,
                        principalTable: "WaterSuppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Notifications_WaterSuppliers_WaterSupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_WaterSupplierId_UserId",
                table: "Notifications",
