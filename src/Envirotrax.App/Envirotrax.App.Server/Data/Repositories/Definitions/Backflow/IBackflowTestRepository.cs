...
public interface IBackflowTestRepository : IRepository<BackflowTest>
{
    ...
    Task<IEnumerable<BackflowTest>> SearchForProfessionalAsync(int professionalId, PageInfo pageInfo, Query query, bool latestOnly, CancellationToken cancellationToken);
}
