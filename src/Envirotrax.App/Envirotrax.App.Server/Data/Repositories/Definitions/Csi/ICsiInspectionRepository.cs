...
public interface ICsiInspectionRepository : IRepository<CsiInspection>
{
    ...
    Task<IEnumerable<CsiInspection>> SearchForAdminAsync(PageInfo pageInfo, Query query, CsiPaymentStatus? paymentStatus, int? inspectorId, CancellationToken cancellationToken);
