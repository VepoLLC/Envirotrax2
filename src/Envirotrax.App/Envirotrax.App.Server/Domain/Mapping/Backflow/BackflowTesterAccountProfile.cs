...
public class BackflowTesterAccountProfile : Profile
{
    public BackflowTesterAccountProfile()
    {
        CreateMap<ProfessionalUser, BackflowTesterAccountDto>()
            ...
            .ForMember(dto => dto.CellNumber, opt => opt.MapFrom(model => model.User!.PhoneNumber))
            .ForMember(dto => dto.IsSubAccount, opt => opt.Ignore());
    }
}
