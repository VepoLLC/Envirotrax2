...
public interface ICsiInspectionService : IService<CsiInspection, CsiInspectionDto>
{
    ...
    Task<IPagedData<CsiInspectionDto>> SearchForWaterSupplierAsync(PageInfo pageInfo, Query query, int? subAccountWaterSupplierId, CancellationToken cancellationToken);
