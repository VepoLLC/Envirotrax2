...
public interface IFogTripTicketService : IService<FogTripTicket, FogTripTicketDto>
{
    ...
    Task<IPagedData<FogTripTicketDto>> SearchForWaterSupplierAsync(PageInfo pageInfo, Query query, int? subAccountWaterSupplierId, CancellationToken cancellationToken);
