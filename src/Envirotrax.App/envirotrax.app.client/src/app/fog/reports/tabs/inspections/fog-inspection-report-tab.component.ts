...
import { FogReportPeriod, FogReportStatItem, FogSystemReport } from "../../../../shared/models/fog/fog-system-report";
...
@Component({
    standalone: false,
    selector: 'fog-inspection-report-tab',
    templateUrl: './fog-inspection-report-tab.component.html'
})
export class FogInspectionReportTabComponent implements OnInit {
    ...
    public async search(): Promise<void> {
        ...
        try {
            this.isLoading = true;
            this.report = await this._reportService.getInspectionReport(this.fromDate, this.toDate);
    ...
    private async setDefaultDateRange(): Promise<void> {
        ...
        const earliest = await this._reportService.getEarliestInspectionDate();
