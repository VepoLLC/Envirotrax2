...
@Component({
    standalone: false,
    templateUrl: './professional-fog-trip-ticket-submission-property-search.component.html'
})
export class ProfessionalFogTripTicketSubmissionPropertySearchComponent implements OnInit {
