...
export class BackflowTesterInsurancesService {
    constructor(
    ...
    public getInsurances(testerId: number, pageInfo: PageInfo, query: Query): Promise<PagedData<ProfessionalInsurance>> {
